        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Connecting talented students with exceptional career opportunities. 
              Elevate your future with Elevatr.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors group"
                aria-label="Twitter"
              >
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              {isAuthenticated() ? (
                <>
                  <li>
                    <Link to="/projects/browse" className="text-gray-300 hover:text-white transition-colors">
                      {user?.role === 'recruiter' ? 'Browse Talent' : 'Browse Projects'}
                    </Link>
                  </li>
                  <li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6">
              {isAuthenticated() && user?.role === 'recruiter' ? 'For Recruiters' : 'For Students'}
            </h3>
            <ul className="space-y-4">
              {isAuthenticated() && user?.role === 'recruiter' ? (
                ...
                <>
                  <li>
                    {isAuthenticated() ? (
                      <Link to="/projects/new" className="text-gray-300 hover:text-white transition-colors">
                        Create Portfolio
                      </Link>
                    ) : (
                      <a href="#" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                © {new Date().getFullYear()} Elevatr. All rights reserved.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              {isAuthenticated() && (
                <p className="text-gray-600 text-xs mt-2">
                  Welcome back, {user?.name}! Keep building your future.
                </p>
              )}
            </div>
          </div>
